  ...
  return (
    <main className="product-main sm:bg-white py-4 md:px-4 flex flex-col gap-4 items-center sm:items-start sm:min-w-96 sm:grid grid-cols-3">
      <Image
        ...
        width={600}
        alt=""
        className="w-full h-[60vh] mx-auto sm:h-auto max-h-[500px] col-span-1 object-contain sm:sticky top-16"
      />
      <div className="bg-white col-span-2 flex flex-col gap-2 py-4">
        <h1 className="uppercase px-4">{item.name}</h1>
